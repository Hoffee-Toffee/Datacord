...
let fileIDs = require('./files.json')
...
const addSound = async () => {
  ...
  let song = fileHost + fileIDs.AMB[nextIndex]
...
const makeTemp = async (tempSeg = minSegs * -1) => {
  if (tempSeg === -1 * minSegs) {
    ...
    // Save to file 'bg.jpg'
    fs.writeFileSync(__dirname + '/bg.jpg', bgImage)
...
module.exports = { start: makeTemp, stop: killProcess }
